...
function Signup() {
  ...
  async function handleFormSubmit(e) {
    ...
    //   toast.error("Password length must be 5 characters or more");
    //   return;
    // }
    console.log(signUpState);
    ...
    <>
      <section className="text-gray-600 body-font">
        <div className="flex flex-wrap items-center h-screen px-10 py-6 mx-auto">
          ...
          <form className="flex flex-col w-full p-8 mt-10 bg-gray-100 rounded-lg lg:w-2/6 md:w-1/2 md:ml-auto md:mt-0" onSubmit={handleFormSubmit}>
            <h2 className="mb-5 text-lg font-medium text-gray-900 title-font">
              Sign up
            </h2>

            <div className="relative mb-4">
              <label htmlFor="role" className="text-sm leading-7 text-gray-700">
              ...
              <select
                ...
                required
                className="w-full px-3 py-2 mt-2 text-base leading-8 text-gray-700 transition-colors duration-200 ease-in-out border border-gray-300 rounded outline-none focus:border-yellow-500 focus:ring-2 focus:ring-yellow-200"
              >
                <option value="">Select a role</option>
                <option value="Farmer">Farmer</option>
                <option value="Ethanol Producing Factory">Ethanol Producing Factories</option>
            ...
            <p className="mt-3 text-xs text-gray-500">
              ...
              <Link to="/auth/signin" className="text-yellow-500">
                Login
              </Link>
            </p>
          </form>
